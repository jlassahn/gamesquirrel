...
static void MX_ICACHE_Init(void)
{
  ...
  */
  ...
  pRegionConfig.RemapAddress = 0x90000000;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(DisplayCMD_GPIO_Port, DisplayCMD_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : DisplayCMD_Pin */
  GPIO_InitStruct.Pin = DisplayCMD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DisplayCMD_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DisplayTE_Pin */
  GPIO_InitStruct.Pin = DisplayTE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DisplayTE_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : DetectSD_Pin */
  GPIO_InitStruct.Pin = DetectSD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DetectSD_GPIO_Port, &GPIO_InitStruct);
